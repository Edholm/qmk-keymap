...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_pretty(
    ...
    KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,                                                                      KC_N,     KC_M,     KC_COMM,  KC_DOT,   SE_MINS,       KC_RSFT,
              SE_SECT,  SE_LABK,  KC_LEFT,  KC_RGHT,                                                                                       KC_UP,    KC_DOWN,  KC_BSLS,  SE_DIAE,
                                            ...
                                            KC_BSPC,  KC_DEL,        LT(_MACRO, KC_END),                               KC_PGDN,  KC_ENTER, LT(_SYMBOLS, KC_SPC)
  ),
  ...
  */
  ...
  //  esc       f1        f2        f3        f4          f5        f6          f7        f8      |   f9         f10        f11        f12        prnt      sclck      pause      keypad   program
    ...
    _______,  SE_HASH,  SE_DLR,   SE_PIPE,  SE_TILD,   SE_GRV,                                                                       SE_PLUS,   SE_PERC,   SE_DQUO,   SE_UNDS,   SE_SCLN,  _______,
              KC_INS,   _______,  _______,  _______,                                                                                            _______,   SE_QUOT,   _______,   _______,
...
// Tweak which keys applies shift on caps word or not.

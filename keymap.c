...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  *
  * ,-------------------------------------------------------------------------------------------------------------------.
  * | Caps   |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |  F8  |  F9  |  F10 |  F12 | PSCR | SLCK | PAUS | KPAD | RESET  |
  * |--------+------+------+------+------+------+---------------------------+------+------+------+------+------+--------|
  * | `´     |  1!  |  2@  |  3#  |  4$  |  5%  |                           |  6^  |  7&  |  8*  |  9(  |  0)  | ?+     |
  * |--------+------+------+------+------+------|                           +------+------+------+------+------+--------|
  ...
  */
  [QWERTY] = LAYOUT_pretty(
    KC_CAPS,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,         KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_PSCR,  KC_SLCK,  KC_PAUS,  TG(KEYPAD),  ___,
    ...
    KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,                                                                      KC_N,     KC_M,     KC_COMM,  KC_DOT,   SE_MINS,     KC_RSFT,
              SE_SECT,  SE_LABK,  KC_LEFT,  KC_RGHT,                                                                                       KC_UP,    KC_DOWN,  KC_BSLS,  SE_DIAE,
                                                      KC_LCTL,  KC_RALT,                                               KC_RCTL,  KC_LALT,
                                                                TD(TD_HOME_WIN),                                       KC_PGUP,
                                            KC_BSPC,  KC_DEL,   LT(KEYPAD, KC_END),                                    KC_PGDN,  KC_ENTER, KC_SPC
  ),
  /**********************************************************************************************************************
  *
  * KEYPAD layer
  ...
  */
  ...
  //  esc       f1        f2        f3        f4          f5        f6          f7        f8      |   f9         f10        f11        f12        prnt      sclck      pause      keypad   program
    ...
    _______,  _______,  _______,  _______,  _______,   _______,                                                                      _______,   _______,   _______,   _______,   _______,  _______,
    _______,  M_HOME,   _______,  _______,  _______,   _______,                                                                      _______,   _______,   _______,   _______,   _______,  _______,
    _______,  _______,  _______,  _______,  _______,   _______,                                                                      _______,   _______,   _______,   _______,   _______,  _______,
...
layer_state_t layer_state_set_user(layer_state_t state) {
    ...
    if (!IS_LAYER_ON_STATE(state, QWERTY)) {
        // Keypad led
